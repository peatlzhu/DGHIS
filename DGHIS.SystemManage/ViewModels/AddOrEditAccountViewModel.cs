...
{
    /// <summary>
    /// 新增用户,编辑用户功能页面viewmodel,用于处理业务逻辑
    /// 调用web api保存数据
    /// </summary>
    public class AddOrEditAccountViewModel : BaseDialogPageViewModel
    {
        IMapper _mapper;
        /// <summary>
        /// 新增预约挂号业务处理构造函数
        ...
        public AddOrEditAccountViewModel(IContainerExtension container,IMapper mapper) : base(container)      
        {
            this._mapper = mapper; 
            InitData();
        }
