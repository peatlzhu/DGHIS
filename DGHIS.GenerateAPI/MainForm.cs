...
namespace DGHIS.GenerateAPI
{
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "接口生成工具【首发于：DGHIS.com】";
        }

        private string currentProject = "DGHIS.GenerateAPI";//當前項目
        private string interfaceDir = "DGHIS.Core\\Apis"; //生成的接口保存目錄
        private string modelDir = "DGHIS.Core\\Models";   //生成的DTO(實體類)保存目錄
        private string enumDir = "DGHIS.Core\\Enums";//生成的枚舉文件保存目錄
